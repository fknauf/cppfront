...
std::deque<std::string> generated_text;
std::deque<std::vector<source_line>> generated_lines;
...
auto tokens::debug_print(std::ostream& o) const
    -> void
{
...
std::deque<tokens> generated_lexers;
